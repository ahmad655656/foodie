...
const Footer = () => {
  return (
      ...
      <div className="w-[80%] mx-auto items-start grid-cols-1 sm:grid-cols-2 grid md:grid-cols-2 lg:grid-cols-4 gap-10 ">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-400 font-medium">
            ...
            distinctio, tenetur exercitationem facere accusamus, harum.
          </p>
        ...
        <div className="space-y-5">
            ...
            <p className="footer__link">Carears</p>
        </div>
        {/* 3rd part */}
        <div className="space-y-5">
    ...
    <div className="mt-6">
        ...
        <h1 className="text-base font-bold text-yellow-300 mt-1">+963983796029</h1>
    </div>
    <div className="mt-6">
